        ...
        <section class="page-banner-area rel z-1 text-white text-center" style="background-image: url(assets/images/banner.jpg);">
            <div class="container">
                <div class="banner-inner rpt-10">
                    <h2 class="page-title wow fadeInUp delay-0-2s text-dark">Courses</h2>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="course-grids">
                            <div class="row">
                                ...
                                <?php
                                $qry = $db->prepare("SELECT * FROM courses WHERE status = '1'");
                                $qry->execute();
                                        ...
                                        <div class="coach-item wow fadeInUp delay-0-4s">
                                            ...
                                            <div class="coach-content">
                                                ...
                                                <div class="ratting-price">
                                                    <span class="price"> <?php echo number_format($rows['price'], 2) ?></span>
                                                </div>
